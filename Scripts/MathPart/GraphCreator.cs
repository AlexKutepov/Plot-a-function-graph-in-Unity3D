...
public class GraphCreator : MonoBehaviour {
    ...
    protected void addTestForYinTheLoop(float i, bool negative = false) {
        ...
        if (i > 0f)
            ...
            else newText.GetComponent<TextMeshProUGUI>().text = Math.Round(i, 1).ToString();
